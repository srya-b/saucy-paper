...
Universal Composability is the leadin theoretical framework for defining the security of message-passing cryptographic and distributed protocols between mutually distrustful parties.
