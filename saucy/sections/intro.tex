...
and probability distribution.\todo{maybe mention existing work}.  The
...
property violation.  \todo{say something about the other bugs that don't
manifest themselves are a result of un-stated properties about efficiency of a
protocol or distributions of output}.  \todo{rephrase the following better as
higher-level concluding thoughts} The cases in which we fail are a consequence
