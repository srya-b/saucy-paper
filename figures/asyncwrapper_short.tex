...
\OnInput \inmsg{\Schedule}{\msf{func}}{\msf{args}} from $\mathcal{F}/P_i$:
	\begin{enumerate}
...
\OnInput \inmsg{\Exec}{\msf{idx}} from \Adversary:
	\begin{enumerate}
...
\OnInput \inmsg{\textsc{Delay}}{\msf{rounds}} from \Adversary:
	\begin{enumerate}
