...
The proof relies on Theorem~\ref{thm:functor}, whose simulator proof is found in Appendix~\ref{app:ms} and a simpler Theorem~\ref{thm:squash}, presented here, 
that allows $!!\F \xrightarrow{\msf{squash}} !\F$. 
...
% We provide it by first proving a much simpler theorem arising from the , Theorem~\ref{thm:functor}, and Theorem \ref{thm:squash}.
