...
Internally, the \partywrapper reads the message, creates a virtual protocol parties if the \m{PID} doesn't already exist, created virtual tokens to send to it, and waits for a message back from the party. 
