...
\begin{mathpar}
	...
	{
		\F_1 : \Delta_{\F_1}'[\Tokentypes][\mathrm{T}_{\F_1}], \F_2 : \Delta_{\F_2}'[\Tokentypes][\mathrm{T}_{\F_1}] \\ 
		\Delta_{\F_1}' \vdash \pi : \Delta_1'[\Tokentypes][\mathrm{T}_{\pi}] \semi \Delta_{\F_2}' \vdash \phi : \Delta_2'[\Tokentypes][\mathrm{T}_{\phi}] \semi \\
		\forall \A \ . \ \Delta_4[\Tokentypes][\mathrm{T}_{\A}], \Delta_1' \vdash \A :: \Delta_3', \matched{\A}{\pi}, \matched{\A}{\F_1} \\
		\Rightarrow \exists \Sim_\A \ . \ (\Delta_3[\Tokentypes][\mathrm{T}_{\Sim}], \Delta_2' \vdash \Sim_\A :: \Delta_3'), \matched{\Sim_\A}{\phi}, \matched{\Sim_\A}{\F_2} \semi \\
		\forall \Z \ . \ \matched{\Z}{\pi}, \matched{\Z}{\phi} \; \msf{execUC} \ \pi\ \F_1\ \Z\ \A \sim \msf{execUC} \ \phi\ \F_2\ \Z\ \Sim_\A
	}
	{
