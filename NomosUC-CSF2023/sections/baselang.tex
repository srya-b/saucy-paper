...
We call these intermediate sub-configuration as \emph{communicator wrapper} (box in Figure~\ref{fig:newpandq}).
...
In the worst case, this means some message are sent with more import than the underlying session type of the wrapped process.
