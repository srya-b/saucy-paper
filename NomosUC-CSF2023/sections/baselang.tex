...
For each session type, in this case 2, the wrapper spawns a generated process, $a_p$ and $b_p$ in the diagram, which offer the session types \m{PtoQ} and \m{QtoP}. 
