...
UC protocols and functionalities are expressed via Interactive Turing Machines that (i) communicate via \emph{mesage tapes} that ITMs can read from/write to,
