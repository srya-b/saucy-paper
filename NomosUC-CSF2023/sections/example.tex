...
In general, the provider relationship in the channel ends up being unimportant in our construction, and we arbitrarily choose one ITM as the provider for
...
In this way the session types becomes a succint description of how a party can use a functionality, and, at a high-level, what the functionality should do.
