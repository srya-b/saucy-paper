...
\begin{mathpar}
	\mi{type} \; \m{msp2f}[s,a]\{n\} = \textcolor{red}{\paypot^n} \ichoice{ \mb{p2mf}: \m{PID} \product \m{SID}[s] \product \m{b} \product \m{msp2f}[s,a]\{n\}} \\
	\mi{type} \; \m{msf2p}[s,a]\{n\} = \textcolor{red}{\getpot^n} \ichoice{ \mb{mf2p}: \m{PID} \arrow \m{SID}[s] \arrow \m{b} \arrow \m{msf2p}[s,a]\{n\}}
\end{mathpar}
