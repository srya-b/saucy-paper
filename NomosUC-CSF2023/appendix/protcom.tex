...
By this same reasoning it may suffice to apply this assignment of import to the session type in Figure~\ref{fig:ropptype} above yielding the following type for the commitment
\begin{center}
	\parbox{0cm}{
	\begin{tabbing}
