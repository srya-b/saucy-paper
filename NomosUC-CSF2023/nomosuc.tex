...
\begin{abstract}
  ...
  This work complements the existing formalizations of UC by introducing a novel abstraction called \emph{import
  ...
  Moreover, IST can be used to statically encode the \emph{import mechanism} in UC used to
