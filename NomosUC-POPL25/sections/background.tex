...
of the protocol in our framework serves as good validation for its expressivity. %: our theorem and proof are parametric in the session type of the protocol, i.e., the theorem places no restrictions
