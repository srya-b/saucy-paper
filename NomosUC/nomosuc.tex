...
%}
\begin{abstract}
The Universal Composability (UC) framework is the leading framework for proving compositional security of cryptographic protocols, however, is limited to on-paper proofs which can be cumbersome and difficult to analyze.
There are a wealth of previous attempts at formalizing it with programming lanuage logic, but many of them still fall short in either expressiveness, capturing full compositional security, and reasoning about resource-bounded protocols and adversaries. 

In this work we propose a programming language called NomosUC that combines resource-aware session types~\cite{nomos} 	
