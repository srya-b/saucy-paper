...
We show how to resolve session types in Nomos...
\anote{finish explanation of the technical challenges in making session types while still supporitng the dynamic nature of UC.}
...
The main technical challenge is the need for \anote{explain why sandboxing requires us to introduce virtual tokens}.
