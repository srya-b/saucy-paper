...
%Since this proof requires adapting a distinguisher for the multiple-sessions experiment to a distinguisher for the single session experiment, the reduction involves a variable sequence of hybrid games. Our encoding of these intermediate steps in our framework shows that our framework is useful for the  but also for hybrid-game constructions that form part of the proof.
