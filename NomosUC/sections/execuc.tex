...
The examples provided in this work do not directly use protocols that allow for an arbitrary number of parties, so we give an environment in Appendix~\red{appendix:arbparties} that runs an execution with the random oracle \Fro presented in the next section.
