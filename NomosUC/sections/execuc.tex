...
\Delta_2 \models (\phi(clist, sid, k, r) : T_\phi) :: \Delta_2'}
{\msf{validF}\ \phi \rightarrow \Delta_1'}
\end{mathpar}
\end{definition}
...
\footnotesize
	...
	\langle \pi \leftrightarrow \F_2 \rangle, \langle \phi \leftrightarrow \F_2 \rangle \\
	\Delta[\mathrm{T}_{\pi}] \equiv_{\Environment} \Delta_1\ 
	\semi \Delta[\mathrm{T}_{\phi}] \equiv_\Environment \Delta_2 \\
	\forall \Adversary, (\exists (\Delta_4, \Delta_4') | \Delta_4 \vdash \Adversary :: \Delta_4',\ \langle \Adversary \leftrightarrow \pi \rangle, \langle \Adversary \leftrightarrow \F_1 \rangle \\  %(\Adversary, \pi), (\Adversary, \F_1) \text{ well-matched }\\
	\Rightarrow \exists (\Delta_3,\Delta_3') | \Delta_3 \vdash \Simulator_\Adversary :: \Delta_3', \langle \Simulator_\Adversary \leftrightarrow \phi \rangle, \langle \Simulator_\Adversary \leftrightarrow \F_2 \rangle \\ %(\Simulator_\Adversary, \phi), (\Simulator_\Adversary, \F_2) \text{ well-matched} \wedge \\
	\forall \Environment (\langle \Environment \leftrightarrow \Adversary \rangle, \langle \Environment \leftrightarrow \pi \rangle \Rightarrow \langle \Environment \leftrightarrow \Simulator_\Adversary \rangle, \langle \Environment \leftrightarrow \phi \rangle \\ %\Environment, (\Simulator_\Adversary, \phi) \text{ well-matched } \wedge \\	
