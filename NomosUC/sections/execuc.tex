...
{\msf{p2f}, \m2f{f2p}, \msf{f2a}, \msf{a2f} \in \Delta_2}
...
{\msf{p2f}, \m2f{f2p}, \msf{p2a}, \msf{a2p}, \msf{z2p}, \msf{p2z} \in \Delta_1}
...
{\Delta_1:, (ftop: \msf{comm}[f2p]), (ptof: \msf{comm}[p2f]) \equiv \\
 \Delta_2, (ftop: \msf{comm}[pid \textasciicircum f2p]), (ptof: \msf{comm}[pid \textasciicircum p2f])}
\end{mathpar}
\end{definition}
...
{\Delta_1:, (atop: \msf{comm}[a2p]), (ptoa: \msf{comm}[p2a]) \equiv \\ 
\Delta_2, (atop: \msf{comm} [pid \textasciicircum a2p]), (ptoa: \msf{comm} [pid \textasciicircum p2a])}
\end{mathpar}
\end{definition}
...
{\Delta_1:, (atof: \msf{comm}[a2f]), (ftoa: \msf{comm}[f2a]) \equiv \\
 \Delta_2, (atof: \msf{comm}[a2f]), (ftoa: \msf{comm}[f2a])}
\end{mathpar}
\end{definition}
...
{\Delta_1:, (ztop: \msf{comm}[z2p]), (ptoz: \msf{comm}[p2z]) \equiv \\
 \Delta_2, (ztop: \msf{comm}[pid \textasciicircum z2p]), (ptoz: \msf{comm}[pid \textasciicircum p2z])}
\end{mathpar}
\end{definition}
...
\footnotesize
	...
	\Delta_1 \vdash (\pi : T_\pi) :: \Delta_1' \semi 
	\Delta_2 \vdash (\phi : T_\phi) :: \Delta_2' \\ 
	(\pi, \F_1) \text{ well-matched }, (\phi, \F_2) \text{ well-matched } \\ 
	\Delta[\mathrm{T}_{\pi}] \equiv_{\Environment} \Delta_1\ 
	\semi \Delta[\mathrm{T}_{\phi}] \equiv_\Environment \Delta_2 \\
	\forall \Adversary, (\exists \Delta_4, \Delta_4', \Delta_4 \vdash \Adversary :: \Delta_4', (\Adversary, \pi), (\Adversary, \F_1) \text{ well-matched }\\
	\Rightarrow \exists \Delta_3,\Delta_3', \Delta_3 \vdash \Simulator_\Adversary :: \Delta_3',(\Simulator_\Adversary, \phi), (\Simulator_\Adversary, \F_2) \text{ well-matched} \wedge \\
	\forall \Environment ((\Environment, (\Adversary, \pi)) \text{ well-matched } \Rightarrow \Environment, (\Simulator_\Adversary, \phi) \text{ well-matched } \wedge \\	
	\msf{execUC} \pi\ \Environment\ \F_1\ \Adversary \sim\ \msf{execUC} \phi\ \Environment\ \F_2\ \Simulator_\Adversary)) }
