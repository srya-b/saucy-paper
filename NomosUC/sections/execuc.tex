...
For the multisession extension of a protocol the type is given as:
\begin{mathpar}
...
\end{mathpar}
Naturally the internals of the multisession wrapper mirror the \fwrapper, but with additional copies.
