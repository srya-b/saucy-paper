...
Sandboxing, or virtualizing, machines \snote{they're the same thing} is a common design pattern in UC, especially with adversaries and simulators.
...
NomosUC overcomes the constraints of statically-typed session types by using a \partywrapper to encapsulate all protocol parties and run them internally.\snote{Removed departure and made it about the constraint being overcome}
