...
It also does not directly capture either of \Fcom's security properties: the type can not enforce the same bit that was committed is the one that is opened.\snote{merged clarification on session types into this paragraph}
