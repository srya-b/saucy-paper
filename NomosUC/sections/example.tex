...
Our key innovation is to represent protocols and ideal functionalities in the UC framework using \emph{session types}.
We illustrate Nomos UC with an example ideal functionality: a cryptographic commitment.
