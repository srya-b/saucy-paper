...
\newcommand{\Sim}[1]{\ensuremath{\Simulator_{#1}}}
\newcommand{\Dummysim}{\ensuremath{\Simulator_{\mathcal{D}}}\xspace}
...
\newcommand{\idealP}{\ensuremath{\mathbb{I}_d}\xspace}
\newcommand{\lla}{\leftarrow}
\newcommand{\lvd}{\vdash}
\newcommand{\tb}[1]{\text{\color{blue}{#1}}}
\newcommand{\tm}[1]{\text{\color{magenta}{#1}}}
\newcommand{\tg}[1]{\text{\color{gray}{#1}}}
\newcommand{\inline}[1]{\lstinline[basicstyle=\small\BeraMonottFamily, mathescape]!#1!}
\newcommand{\nrecv}{\tb{recv}}
\newcommand{\nsend}{\tb{send}}
\newcommand{\nget}{\tb{get}}
\newcommand{\npay}{\tb{pay}}
